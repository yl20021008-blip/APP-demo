...
st.title('⚙️ 词汇补全中心')
st.caption('补全的是公共词库字段。v1.3 增强：词典无例句时自动生成雅思学习例句，并自动翻译。')
...
with left:
    batch_size = st.slider('每批处理数量', min_value=1, max_value=100, value=25, step=5)
...
st.info('建议：先每批25个测试。确认效果后，可以每批50-100个。生成例句会标记来源为 local_generated_ielts_example。')
